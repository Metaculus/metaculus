    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                [
                    (0, ["a", "b", "other"]),
                    (datetime(2024, 1, 1).timestamp(), ["a", "other"]),
                ],
                {
                    "probability_yes_per_category": {
                        "a": 0.6,
                ...
                [
                    Forecast(
                        probability_yes_per_category=[0.6, 0.0, 0.4],
                        start_time=datetime(2025, 1, 1, tzinfo=dt_timezone.utc),
                        end_time=datetime(2026, 1, 1, tzinfo=dt_timezone.utc),
                    ),
                ],
            ...
            (
                [
                    (0, ["a", "b", "other"]),
                    (datetime(2024, 1, 1).timestamp(), ["a", "b", "c", "other"]),
                ],
                {
                    "probability_yes_per_category": {
                        "a": 0.6,
            ...
            (
                [
                    (0, ["a", "b", "other"]),
                    (datetime(2026, 1, 1).timestamp(), ["a", "b", "c", "other"]),
                ],
                {
                    "probability_yes_per_category": {
                        "a": 0.6,
