    ...
    <>
      ...
      <main className="flex flex-col items-center justify-center p-3 sm:p-5 ">
        ...
        <div className="mx-8 text-blue-800 dark:text-blue-800-dark sm:mx-12 md:max-w-[670px]">
          ...
          <p>
            Register for the contest and be notified as soon as questions
            open. The earlier you forecast, the better your odds to beat the
            competition and win cash prizes!
          </p>
          <p>
            <i>Curious to see the questions, winners, and schools represented in 
            the previous Bridgewater x Metaculus contest? Find them{" "}
            <Link href={"https://www.metaculus.com/tournament/bridgewater/"}>here.</Link>.</i> 
          </p>
        </div>
      </main>
    </>
