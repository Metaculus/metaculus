    ...
    <PageWrapper>
      ...
      <div className="flex flex-col">
        ...
        <p>
          ...
          prediction market, and we go into detail about these in our blog post <i><a href="https://www.metaculus.com/notebooks/38198/metaculus-and-markets-whats-the-difference/ target="_blank">Metaculus and Markets: What's the Difference?</a></i>. Here's a graphic from that post with a quick overview:
        </p>
        ...
        <ol className="mb-4 ml-4 list-inside list-decimal space-y-2">
          <li>
            A &quot;credible source&quot; will be taken to be an online or print published article from a journalistic or academic source, information publicly posted by an authoritative source with specific knowledge or responsibility for the subject matter, or in general information from a source where the preponderance of evidence suggests that the information is correct—provided in all cases that there is no significant controversy surrounding its correctness. Credible sources will generally not include unsourced information found in blogs, social media postings, or websites of individuals.
          </li>
          <li>
