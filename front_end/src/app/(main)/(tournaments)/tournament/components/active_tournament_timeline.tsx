...
const ActiveTournamentTimeline: FC<Props> = async ({
  ...
  const closeDate = tournament.close_date ?? latestScheduledResolutionTimestamp;
  ...
  return (
    <div className="flex flex-1 flex-col">
      ...
      <div className="relative my-2.5 flex h-1 w-full rounded bg-blue-400 dark:bg-blue-400-dark sm:my-3">
        ...
        >
          <FontAwesomeIcon
            icon={faChevronRight}
            className={cn(
              "absolute -right-0.5 -top-1.5 text-blue-700 dark:text-blue-700-dark",
              (progressPercentage < 5 || progressPercentage > 95) && "hidden"
            )}
          />
        </div>
      ...
      <div className="flex w-full justify-between">
        {/* TODO: adjust dates formats - add years if tournament is more than 1 year old? */}
