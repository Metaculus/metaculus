export const JOBS_INSIGHTS = {
  "2027": {
    positive: (
      <>
        By 2027, <strong>nurses</strong> are expected to see mild growth driven
        by the health needs of an aging population.
      </>
    ),
    negative: (
      <>
  ...
  "2030": {
    ...
    negative: (
      <>
        ...
        declines as AI absorbs coding, rules-based analysis, and customer
        outreach work. Software development leads the drop, with rapid AI
