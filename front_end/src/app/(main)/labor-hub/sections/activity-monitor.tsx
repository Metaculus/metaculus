    ...
    <section className={cn("xl:py-8", className)} {...props}>
      ...
      <div className="grid gap-5 sm:gap-6 md:grid-cols-2 md:gap-8">
        ...
        <div className="flex flex-col gap-2.5 md:order-1">
          <ActivityCard date="Nov 13, 2025" degradeIndex={0}>
          ...
          <ActivityCard date="Nov 11, 2025" degradeIndex={1}>
          ...
          <ActivityCard date="Oct 28, 2025" degradeIndex={2}>
          ...
          <ActivityCard date="Oct 21, 2025" degradeIndex={3}>
