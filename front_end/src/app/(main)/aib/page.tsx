      ...
      <div className="flex size-full flex-col items-center gap-3">
        ...
        <div className="flex size-full flex-col gap-3 md:flex-row">
          ...
          <div className="flex h-auto w-full flex-col gap-3 md:w-1/3">
            {!isUserAuthenticated && (
              <div className="bg-metac-blue-800 dark:bg-metac-blue-800-dark dark:text-metac-blue-900 flex h-auto w-full grow flex-col items-center justify-center gap-2 rounded p-8 text-white lg:px-12">
            ...
            {isUserAuthenticated && isUserBot && (
              <div className="bg-metac-blue-800 dark:bg-metac-blue-800-dark dark:text-metac-blue-900 flex h-auto w-full grow flex-col items-center justify-center gap-2 rounded p-8 text-white lg:px-12 min-[1920px]:gap-6">
