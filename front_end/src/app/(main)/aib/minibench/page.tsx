import { faArrowLeft, faInfoCircle, faTrophy } from "@fortawesome/free-solid-svg-icons";
                ...
                <div className="mb-10 rounded-lg bg-white p-6 dark:bg-blue-100-dark">
                    ...
                    <div className="space-y-3 text-blue-700 dark:text-blue-700-dark">
                        ...
                        <p className="m-0 leading-relaxed">
                            <a href="/notebooks/38928/ai-benchmark-resources/#what-do-the-tournaments-look-like" className="text-blue-700 dark:text-blue-700-dark">{t("FABReadMore")}</a>
                        </p>
                    </div>
                </div>
