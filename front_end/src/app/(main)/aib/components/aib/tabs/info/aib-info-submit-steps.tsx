...
const AIBInfoSubmitSteps: React.FC = () => {
  return (
    <div className="flex gap-[60px] antialiased">
      <div className="flex flex-1 flex-col gap-[26px] rounded-[13px] bg-blue-900 p-8 dark:bg-blue-900-dark">
      ...
      <div className="my-6 flex-1">
        <h4 className="m-0 mb-[55px] text-4xl font-bold text-blue-800 dark:text-blue-800-dark">
...
const AIBInfoSubmitStep: React.FC<{
  ...
  return (
    <div className="flex items-center gap-6">
      ...
      <p className="m-0 text-2xl text-gray-800 dark:text-gray-800-dark">
        {content}
      </p>
    </div>
  );
