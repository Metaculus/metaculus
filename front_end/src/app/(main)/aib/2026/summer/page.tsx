...
import AiBenchmarkingTournamentPageSummer2026 from "../../components/page-view-2026-summer";
...
export default async function Settings() {
  ...
  return (
    <AiBenchmarkingTournamentPageSummer2026 primaryBotToken={primaryBotToken} />
  );
}
