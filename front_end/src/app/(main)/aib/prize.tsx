function Prize() {
  return (
    <div className="flex size-full min-h-[90px] grow flex-row items-center justify-center lg:h-auto lg:min-h-[180px]">
      <div className="relative z-20 flex size-full select-none flex-col items-center justify-center gap-1 rounded border-olive-700 bg-olive-500/50 py-4 text-olive-800 dark:bg-olive-500/30 dark:text-olive-900-dark md:gap-2 lg:gap-3">
