...
export const TwoStepKeyFactorItem: FC<Props> = ({
  ...
  return (
    <div
      className={cn(
        "relative flex flex-col gap-3 rounded border border-transparent bg-blue-200 p-3 md:hover:border-blue-500 dark:bg-blue-200-dark md:dark:hover:border-blue-500-dark md:[&:hover_.target]:visible",
