...
const PanelContainer: FC<Props> = ({
  ...
  const panel = (
    <div
      ref={ref}
      style={getAnchorStyle(anchorRef)}
      className={cn(
        "relative flex flex-col items-center rounded-xl bg-blue-200 shadow-lg ring-1 ring-blue-400 dark:bg-blue-200-dark dark:ring-blue-400-dark",
