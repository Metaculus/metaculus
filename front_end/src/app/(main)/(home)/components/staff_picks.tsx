    ...
    <div className="flex items-center gap-2 overflow-x-auto px-4 py-3 [-ms-overflow-style:none] [scrollbar-width:none] md:py-5 [&::-webkit-scrollbar]:hidden">
      ...
      {items.map((item, idx) => (
        <Link
          ...
          href={item.url}
          className={cn(
            "flex shrink-0 items-center gap-1 rounded-full border-0 bg-gray-0 py-2 pl-3 pr-4 text-xs font-medium leading-3 text-blue-700 no-underline transition-colors hover:bg-blue-400"
          )}
        >
