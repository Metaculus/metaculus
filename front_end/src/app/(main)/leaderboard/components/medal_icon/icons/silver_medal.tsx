...
const SilverMedal: FC<SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg
      width="20"
      height="20"
    ...
    >
      <g id="Group 856">
        ...
        />
        <g id="Ellipse 70" opacity="0.5" filter="url(#filter0_d_484_6553)">
          <path
        ...
        <g id="Ellipse 68" opacity="0.7" filter="url(#filter1_d_484_6553)">
          <path
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_484_6553"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_484_6553"
            result="shape"
          />
        </filter>
        <filter
          id="filter1_d_484_6553"
          x="2.00012"
          y="2.96436"
          width="14.5355"
          height="14.5356"
