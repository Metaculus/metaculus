...
const ContentTranslatedBanner: FC<{
  ...
  return (
    <div
      className={cn(
        "flex w-full justify-center gap-8 border-t border-t-blue-500/50 bg-gradient-to-b from-white/65 to-white shadow-md backdrop-blur-sm dark:border-t-blue-700/50 dark:from-blue-900/65 dark:to-blue-900",
        className
      )}
    >
