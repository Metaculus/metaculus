...
const sampleKeyFactor: KeyFactorAnalysis = {
  results: {
    mainFinding: "Chances of US presidential elections with faithless electors: 8.4746% per US presidential elections",
    numeratorSize: "5 US presidential elections with faithless electors between January 7, 1789 and October 29, 2024",
    denominatorSize: "59 US presidential elections between January 7, 1789 and October 29, 2024",
    dateRange: "Jan 07, 1789 to Oct 29, 2024 | 86127 days, 2870.90 months, 235.96 years"
  },
  background: "Faithless electors have been a rare occurrence in U.S. presidential elections. According to the National Archives, faithless votes were cast in the 2016 election in Hawaii, Texas, and Washington. Historically, faithless electors have appeared in a small number of elections. For example, in 2016, there were seven faithless electors, which was the highest number since 1972. However, no elector has ever been prosecuted for failing to vote as pledged, although some were disqualified and replaced, and others fined in 2016.",
  numerator: {
    size: 5,
