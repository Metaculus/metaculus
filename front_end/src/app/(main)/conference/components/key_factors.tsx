...
const KeyFactors = ({ questionId }: KeyFactorsProps) => {
  ...
  return (
    <div
      className="mt-2 max-h-[400px] cursor-pointer overflow-y-auto rounded-lg border border-gray-200 bg-white py-2 pl-4 [text-align:left!important] dark:border-gray-700 dark:bg-gray-900"
