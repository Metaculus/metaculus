    ...
    >
      ...
      >
        <div className="flex flex-col items-start gap-4">
          <p className="m-0 flex items-center gap-2 text-xs font-medium text-blue-700">
            <span
              aria-hidden="true"
              className="size-1.5"
              style={{ backgroundColor: initiative.brand.color }}
            ...
            {label}
            {feature.badgeKey && (
              <span className="rounded-sm border border-blue-400 px-1 text-[10px] font-semibold uppercase leading-4 text-blue-700">
                {t(feature.badgeKey)}
              </span>
            )}
          </p>

          <h3 className="m-0 text-[28px] font-medium leading-[110%] tracking-[-0.56px] text-blue-900 md:text-[32px] md:tracking-[-0.64px]">
            {t(feature.headingKey)}
          </h3>

          <p className="m-0 text-sm leading-[140%] text-blue-700">
          ...
          <Button
            ...
            className="h-9 rounded-md border-[rgba(33,48,67,0.40)] bg-transparent px-3.5 py-0 font-semibold leading-[14px] text-blue-900"
          >
        ...
        {feature.partners && feature.partners.length > 0 && (
          <div className="flex flex-col gap-3">
            <p className="m-0 text-[10px] font-medium uppercase tracking-[0.12em] text-blue-600">
