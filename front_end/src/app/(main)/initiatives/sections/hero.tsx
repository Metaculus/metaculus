  ...
  return (
    <section className="flex flex-col items-center gap-4 px-5 pb-10 pt-6 text-center md:gap-8 md:px-12 md:pt-14 xl:pb-20">
      <div className="flex flex-col items-center gap-4 md:gap-6">
        ...
        <h1 className="m-0 max-w-[764px] text-balance text-[36px] font-medium leading-[100%] tracking-[-0.03em] text-blue-900 dark:text-blue-900-dark md:text-[60px] md:tracking-[-0.035em]">
          {t(hero.headingKey)}
        </h1>
      </div>
