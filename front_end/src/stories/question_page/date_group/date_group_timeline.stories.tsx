...
const ongoingArgs = getDateGroupMockData(false);
const closedArgs = getDateGroupMockData(true);
    ...
    postData: {
      ...
      group_of_questions: {
        ...
        questions: ongoingArgs.group_of_questions.questions.map((q) => ({
          ...
          status: "open",
          actual_resolve_time: null,
          actual_close_time: q.actual_resolve_time,
          resolution: null,
        })),
      },
    } as unknown as PostWithForecasts,
    ...
    postData: {
      ...
      group_of_questions: {
        ...
        questions: closedArgs.group_of_questions.questions.map((q) => ({
          ...q,
          resolution: q.resolution ? "2028-07-24T16:00:00Z" : null,
          status: q.resolution ? "resolved" : "open",
          actual_resolve_time: q.resolution ? "2025-07-24T16:00:00Z" : null,
          actual_close_time: null,
        })),
      },
    } as unknown as PostWithForecasts,
