export const onboardingTopics = [
  {
    ...
    factors: [
      "A hearing on the Biden admin’s proposal to reclassify marijuana was delayed to December 2nd.",
      "Despite increasing public support for cannabis decriminalization, there remains significant political resistance, particularly from more conservative or law-and-order-focused lawmakers and constituencies.",
      "Some senators have raised the objection that decriminalizing marijuana would violate some trade treaties.",
    ], // Factors for Question2
  },
  {
    name: "World News",
