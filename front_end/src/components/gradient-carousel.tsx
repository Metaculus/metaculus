...
function ReusableGradientCarousel<T>({
  ...
  const fadeCls = `transition-opacity duration-[${fadeMs}ms]`;
  ...
  useEffect(() => {
    ...
    const preventNativeDrag = (e: DragEvent) => {
      ...
      if (!el) return;
      if (el.tagName === "IMG" || el.closest("a")) e.preventDefault();
    };
        ...
        <>
          <button
            ...
            className={cn(
              ...
              arrowClassName,
              fadeCls,
              canPrev || loop ? "opacity-100" : "pointer-events-none opacity-0"
            )}
          >
          ...
          <button
            ...
            className={cn(
              ...
              arrowClassName,
              fadeCls,
              canNext || loop ? "opacity-100" : "pointer-events-none opacity-0"
            )}
          >
