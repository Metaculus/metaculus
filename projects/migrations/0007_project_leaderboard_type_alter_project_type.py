...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='project',
            name='type',
            field=models.CharField(choices=[('tournament', 'Tournament'), ('global_leaderboard', 'Global Leaderboard'), ('question_series', 'Question Series'), ('category', 'Category'), ('tag', 'Tag'), ('topic', 'Topic')], db_index=True, max_length=32),
        ),
    ]
