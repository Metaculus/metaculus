...
from utils.frontend import build_post_comment_url, build_frontend_account_settings_url
...
def send_forecast_auto_withdrawal_notification(user: User, posts_data: list[dict]):
